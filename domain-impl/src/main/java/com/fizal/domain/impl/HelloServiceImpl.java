...
import com.fizal.domain.api.GreetingMessage;
import com.fizal.domain.api.HelloService;
import com.fizal.domain.model.HelloCommand;
import com.fizal.domain.model.HelloCommand.Hello;
import com.fizal.domain.model.HelloCommand.UseGreetingMessage;
import com.fizal.domain.model.HelloEntity;
import com.fizal.domain.model.HelloEvent;
...
public class HelloServiceImpl implements HelloService {
    ...
    @Override
    public Topic<com.fizal.domain.api.HelloEvent> helloEvents() {
        ...
        return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
                ...
                persistentEntityRegistry.eventStream(tag, offset).map(eventAndOffset -> {
                    ...
                    com.fizal.domain.api.HelloEvent eventToPublish;
                    ...
                    if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
                        ...
                        eventToPublish = new com.fizal.domain.api.HelloEvent.GreetingMessageChanged(
